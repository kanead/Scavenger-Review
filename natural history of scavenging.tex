...
Alternatively, selection might drive a species to reduce its metabolic requirements so that it can survive long periods between meals, or expand a species ability to  process tissues or decaying flesh that might ordinarily be discarded.
However, as we noted above, encounter rate is also determined by the productivity of the environment, and ultimately the rate at which carcasses are produced,  an aspect which the selective forces acting on the scavenger have no influence. 
...
\section*{Conclusion}
%TG: not sure where to put that in the conclusion but it'll be cool to mention that our scavenger scale can not only be used for the past but also for species hard to observe in the present (or even - if going wild - for predicted behavioral changes in the future!)
