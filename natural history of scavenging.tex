...
These birds consist of two convergent groups, from the old and the new world where they represent the only example of obligate vertebrate scavengers today. %TG: Or "obligate vertebrate scavengers known to date." For a more emphasizing turn.
...
However, some fossils evidences as early as in the Eocene (56 to 33.9 Mya) suggest the presence of possible scavenging bats.
A big bat from the middle to late Eocene (56 to 33.9 Mya) bat with a robust cranio-mandibular morphology, \textit{Necromatis} (``death-eater''), could have intake carrion as a decent proportion of its diet \citep{Weithofer_Necromantis_1887,Hand_Necromantis_2012}.
However, this example might be peculiar to this exceptional fossil since most other fossils seems less suited to this lifestyle \citep{eiting2009global}. 
%Although it does not seem that flight is the main criterion precluding them from scavenging (see below).
%TG: Actually, maybe this example fits better in the food processing part (and maybe change the silhouettes in the picture then)?
%``The name Necromantis (``death-eater'') alludes to the diet that Weithofer assumed for this bat – carrion, but probably also small, live vertebrates, including mammals such as rodents and other bats.'' from the paper \cite{Hand_Necromantis_2012}.
