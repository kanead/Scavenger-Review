...
The particular reliance of hyenas on carrion means we can use them as examples of efficient terrestrial scavengers to compare with other forms \textcolor{blue}{\citep{periquet2015lion}}. 
...
\subsection{\textcolor{blue}{Carcass} Availability}
...
\textcolor{blue}{In water, by contrast, competition with micro-organims is significantly reduced because of the high pressures and low temperatures \citep{beasley2012carrion}.}
