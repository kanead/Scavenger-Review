...
Each of these facets are essentially the backbone of fundamental ecological theory and are the key parameters defined in functional response curves, namely encounter rate, handling time and prey availability \citep{jeschke2002predator}. %TG: Jaysus, this sentence doesn't read well! "Functional response curves of optimal foraging theory" can probably be phrased in a nicer/easier way...
...
%TG: Hmm I get the point of gas exchange efficiency but (1) it should be more developed if left like that (i.e. what the flip is meant by gas efficient exchanges) and (2) that works for mammals, but in terms of terrestrial that ignores birds, squamates, crocodiles and amphibians.
...
%the second sentence does not really follow from the first -
...
%KH you could reference all the shit on theropod scavenging here if you wanted.
...
%KH I also don't like this sentence as it wouldn't be pointless, 
...
%KH I changed it to make it less confusion with regards to dimension.
...
%KH this kinda jumps ahead about the aerial foraging thing which really dominates the section.
...
%%KH I'm not sure of the argument here and I'm kinda finding it hard to grasp the tread of this entire section to be honest.  
...
%%KH I think this shouldn't be the first place we mention humans as they do appear and fit well in other sections.
%KH Here and in other section there is a lack of mentioning fossil/remains etc. For example I'm sure there is something about the tools or the marks on the bones that would fit in well here.
...
%KH should this go in the prey availability section?
...
% KH I would mention that competition really only affects smaller individuals in this scenario. That is without competition in the model big things did about just as well but small ones did much better. Maybe take the shift in optimum between the models as an example of the affect. 
...
%% KH This sound specific to theropods while if I remember correctly its for mammals. I think we may need to say this in a more general aspect (again changing structure may help. (i.e a stomach section would allow snakes to be included and other extremes))
...
%%KH I think the focus needs to be more on the actual environment and opportunities available. I would suggest that compititon either stays in the handling section (my preference) or is moved down to here (which also works really). 
%%KH You could then split the structure into production in terrestial/marine which focuses on primary productivity and species composition and how they affect what available then the next part being competition in both section.
...
%% KH check out this paper on Mesozoic reptile falls http://www.nature.com/ncomms/2014/140910/ncomms5789/full/ncomms5789.html
