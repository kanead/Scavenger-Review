...
In the simplest case, this rate can be thought of in terms of a gas molecules diffusion model where the movement of two agents (i.e. predators and preys) depends only on their relative speed.
Vertebrates do more than simply bump into resources like gas molecules though, because predators can actively detect preys through their sensory abilities. %TG: I like the gas diffusion analogy but it might be adding too much text and be not essential. I've added some precisions though.
...
There is evidence too of scavening in extinct species, where shark teeth have been found in the remains of dinosaurs, mosasaurs and Pliocene mysticete whales \citep[5.3-3.6 Mya; ][]{schwimmer1997scavenging,ehret2009caught}. 
...
This allows us to make a broad distinction between the ambush strategies of cats-like and the pursuit/ pounce strategies of dogs-like%TG: I've added the "-like" to underline that we're not talking about the phylogeny here (i.e. not Felidae (incl. hyena) vs Canidae)
...
Much work has focused on the existence of scavenging in dinosaurs by using simple energetics approaches that typically focused on a single species namely \textit{T. rex} \citep{ruxton2003could,carbone2011intra} but a recent modelling study investigated its prevalence across a range of body sizes.%TG: missing THE cite here!
