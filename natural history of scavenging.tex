...
The habitat must also be productive enough to sustain a pool of animal biomass that will eventually produce carcasses.
These facets are essentially the key parameters found in the species functional response curves of optimal foraging theory, namely encounter rate, handling time and prey availability \citep{jeschke2002predator}. 
Here, we can draw on these aspects to envisage a scavenger moving through its environment, searching for food and trying to process it efficiently as we explore the prevalence of scavenging through time. 
Our aim is to produce a 'scale of scavenging' whereupon we can place any species, past or present, and assess the importance of scavenging in its diet. 
...
As endotherms, mammals can sustain long bouts %TG: not sure about "bouts" get it with the context and I know it makes the whole review a bit more literary and thus nicer to read but it might exclude non-native english readers. 
 of energetically expensive activity \citep{bennett1979endothermy}. 
By contrast, modern reptiles are ectothermic, limiting their activity periods \citep{bennett1979endothermy}.
% a successful reptilian scavenger requires a far different set of adapations.
This is exacerbated by the sprawling gait seen in many lizards which results in the phenomenon known as Carrier's Constraint such that the animal can't move and breathe at the same time because the lateral movements impedes its lungs \citep{carrier1987evolution}.
These constraints manifest in aspects such as maximum sustainable speed where an equivalent mammal enjoys a six to seven fold increase \citep{ruben1995evolution}.
...
Of course, the importance of terrestrial tetrapods predates the evolution of the dinosaurs. %TG: I will down that "dominance" term. Maybe change the sentence to "Of course the importance of terrestrial tetrapods in ecosystems predates the evolution of the dinosaurs." AK Done 
...
And it is with the evolution of endothermy in the therapsid-mammal lineage \citep{clarke2010temperature} that terrestrial vertebrates would have gained the ability to range more widely, a vital component in seeking out carrion. 
...
But it is in the air that we find scavengers \textit{par excellence}. %TG: not sure how reviewers will go with French but I like it!
...
The advantage of flight can be extended further in larger species that engage in soaring instead of flapping flight, which is even cheaper still for searching the environment \citep[approximately twice the basal metabolic rate; ][]{hedenstrom1993migration,spivey2014analysing}.
...
The difficulty inherent in observing marine birds foraging at sea means our knowledge of their feeding habits is limited. 
But it does seem that albatrosses, who can range many hundreds of kilometres, take a substantial amount of carrion in their diet \citep{croxall1994dead}.
...
In vultures, who are more easily observed on land, we have the best known scavengers on Earth. 
These birds consist of two convergent groups, from the old and the new world where they represent the only example of obligate vertebrate scavengers to date. %TG: Or "obligate vertebrate scavengers known to date." For a more emphasizing turn.


%TG: I thought the paragraph was a bit long so here's a cut for "flying scavengers in the past"
The two families from which modern vultures arose, the Accipitridae and Cathartidae, appear during the Palaeocene \citep[66 - 56 Mya; ][]{Jetz2012, Jarvis2014}.
Yet, avian flight is far older than this and originates in the Late Jurassic (163.5-145 Mya), conincident with the fossils of \textit{Archaeopteryx lithographica}, so many of the benefits of flight would have been realised from that point on for carnivorous birds.
Vertebrate flight is much older still, where pterosaurs predate bird origins by a considerable margin in the Late Triassic (235-201.3 Mya).
Scavenging in this diverse group has been hypothesied many times before \citep{witton2008reappraisal}.
Certain clades of these animals could reach enormous sizes \citep[e.g. Azhdarchids with wingspans of 11 metres; ][]{witton2010size} and, notably, appear to have engaged in soaring flight \citep{witton2010size}.
...
However, some fossil from the Eocene (56 to 33.9 Mya) suggest the presence of possible scavenging bats.
A large bat from the middle to late Eocene (56 to 33.9 Mya) with a robust cranio-mandibular morphology, \textit{Necromatis} (``death-eater''), could have intake carrion as a significant proportion of its diet \citep{Weithofer_Necromantis_1887,Hand_Necromantis_2012}.
Although, this example might be peculiar to this exceptional fossil given most other remains represent animals less suited to the lifestyle \citep{eiting2009global}. 
...
This has led some researchers to argue for the feasibility of an obligate scavenging fish \citep{ruxton2004energetic,ruxton2005searching}. 
As in aerial and terrestrial environments we have evidence of facultative scavenging among extinct aquatic species.
For example, shark teeth have been found in the remains of dinosaurs, mososaurs and 4-million-year-old mysticete whales \citep{schwimmer1997scavenging,ehret2009caught}.  
%the remains of a mosasaur and a terrestrial hadrosaur were discovered with embedded teeth from a Cretaceous shark, \textit{Squalicorax} \citep{schwimmer1997scavenging}.
%As well as a likely instance of scavenging between a 4-million-year-old white shark (\textit{Carcharodon}) and  whale from Peru \citep{ehret2009caught}.
Extant White sharks (\textit{Carcharodon carcharias}) too are known to feed on whale carcasses \citep{fallows2013white}. 
