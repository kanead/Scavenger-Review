...
So, despite being unlikely \textcolor{red}{Is there an estimate of how much of the fishes diet can be made up from this type of scavenging?}, the energetic feasibility of a marine scavenger that specialises on large carcasses has a long history.
...
Moreover, oceanic productivity is also impacted by climactic conditions. \textcolor{red}{I would delete the last two lines of this paragraph and merge it with the next one}
...
\textcolor{blue}{In savannah, dense vegetation can prevent vultures from landing to a carcass because they will be unable to take off again \citep{bamford2009effect} \textcolor{red}{This is a biotic interaction so I would either remove it or move it somewhere else}. 
