...
The same reasoning can be applied to crocodiles and their allies \citep{forrest2003evidence} because a sit and wait strategy is viable for an ectotherm \citep{forrest2003evidence,moleon2015carcass}. 
...
Because of the inherent unpredictability of carrion, scavenging depends more on the ability to efficiently move over large areas than does predation.
